...
$_SESSION['avatar_path']      = $perfil['avatar_path'];
...
switch ($result['rol']) {
    ...
    case 'impulsa_emprendedor':
        ...
        break;
    case 'impulsa_cliente':
        header('Location: /views/clientes/clientes_dashboard.php');
        break;
    case 'impulsa_marketing':
        header('Location: /views/marketing/marketing_dashboard.php');
        break;
    default:
        header('Location: /index.php?login_error=invalid');
}
