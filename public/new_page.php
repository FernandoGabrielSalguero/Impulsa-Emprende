...
<body>
    <main class="page-public-wrap">
        ...
        <form id="new-page-form" class="form-modern im-formulario" method="post" action="new_page_controller.php">
            <section class="page-card im-tarjeta">
                <h2>Datos iniciales</h2>
                <div class="page-grid im-grilla">
                    <div class="page-field im-campo">
            ...
            <section class="page-card im-tarjeta">
                ...
                <div class="page-grid im-grilla">
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q1_nombre_comercial" name="q1_nombre_comercial" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q2_actividad" name="q2_actividad" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q3_objetivo" name="q3_objetivo" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q4_publico" name="q4_publico" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q5_accion_principal" name="q5_accion_principal" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q6_propuestas_destacar" name="q6_propuestas_destacar" required data-im-campo="textarea"></textarea>
                    </div>
                </div>
            </section>
            ...
            <section class="page-card im-tarjeta">
                ...
                <div class="page-grid im-grilla">
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q7_diferencial" name="q7_diferencial" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q8_secciones" name="q8_secciones" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q9_textos" name="q9_textos" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q10_contacto" name="q10_contacto" required data-im-campo="textarea"></textarea>
                    </div>
                </div>
            </section>
            ...
            <section class="page-card im-tarjeta">
                ...
                <div class="page-grid im-grilla">
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q11_material_marca" name="q11_material_marca" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q12_estilo_visual" name="q12_estilo_visual" required data-im-campo="textarea"></textarea>
                    </div>
            ...
            <section class="page-card im-tarjeta">
                ...
                <div class="page-grid im-grilla">
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q14_recursos_visuales" name="q14_recursos_visuales" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q15_imagenes_apoyo" name="q15_imagenes_apoyo" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q16_dominio_hosting" name="q16_dominio_hosting" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q17_correos_corporativos" name="q17_correos_corporativos" required data-im-campo="textarea"></textarea>
                    </div>
                    ...
                    <div class="page-field full im-campo im-campo--ancho">
                        ...
                        <textarea id="q18_requerimientos_adicionales" name="q18_requerimientos_adicionales" required data-im-campo="textarea"></textarea>
                    </div>
                </div>
