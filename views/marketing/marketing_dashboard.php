...
<div class="layout im-aplicacion">
    ...
    <main class="main im-contenedor">
        <header class="navbar im-barra-superior"><div class="navbar-left"><button class="btn-icon im-boton-icono" onclick="toggleSidebar()"><span class="material-icons">menu</span></button><div class="navbar-title">Dashboard comercial de marketing</div></div><?= renderBotonPerfil($perfil['avatar_path'] ?? ($_SESSION['avatar_path'] ?? null)) ?></header>
        <section class="content page-stack im-contenido">
            <div class="marketing-card hero-card im-tarjeta"><h1>Marketing y Panel Comercial</h1><p class="muted">Hola, <?= $displayName ?>. Vista consolidada de inversion, resultados y metricas comerciales.</p></div>
            <form class="marketing-card filters im-tarjeta" method="get">
                ...
                <button class="btn btn-aceptar im-boton im-boton--principal" type="submit">Filtrar</button>
            </form>
            <?php
            ...
            <div class="marketing-card im-tarjeta">
                <h2>Campañas</h2>
                <div class="table-wrap im-tabla-contenedor"><table class="marketing-table im-tabla">
